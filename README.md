...
Sessions allow the server to store entered information about a client, such as authentication credentials (persisting data across requests).

2. What does bcrypt do to help us store passwords in a secure manner.

Bcrypt hashes a client’s password using an algorithm and x-number of rounds to create a complex string.

3. What does bcrypt do to slow down attackers?

Bcrypt uses an x-number of rounds (re-hashing of the password and consequent hashes) to slow down attackers.
